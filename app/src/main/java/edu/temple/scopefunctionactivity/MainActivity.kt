...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("function 2 output false", averageLessThanMedian(listOf(12.1, 12.3, 19.1)).toString())
    }
    ...
    // Return a list of random, sorted doubles
    private fun getTestDataDoubleArray() = (MutableList(10){ Random.nextDouble()}).sorted()
